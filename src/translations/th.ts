...
export const th = {
    ...
    translation: {
        ...
        categoryFooter: {
            ...
            seoDescription2Part1: `คุณภาพ ช่วยให้เว็บไซต์ของคุณแสดงเป็นอันดับต้น ๆ บน Google ทำให้เว็บไซต์ของคุณมีโอกาสที่คนเข้าชมสูงขึ้นและเป็นที่รู้จักมากขึ้น ที่ ${getAppDomain()} เรามีฟรีแลนซ์ให้บริการ SEO ผู้เชี่ยวชาญที่มีประสบการณ์ในการ `,
        ...
        home: {
            ...
            platformDescription: `${getAppDomain()} คือเว็บไซต์ที่รวบรวม ฟรีแลนซ์ มืออาชีพจากหลากหลายสายงานไว้ในที่เดียวกัน ไม่ว่าจะเป็น งานออกแบบกราฟิก ทำแบนเนอร์โฆษณา เขียนบทความ แปลภาษา การตลาดออนไลน์ พัฒนาเว็บไซต์ และงานอื่นๆ อีกกว่า 90 หมวดหมู่ เพื่อตอบโจทย์ความต้องการที่หลากหลายของทั้งผู้ประกอบการและผู้ใช้งานทั่วไป ทีมพัฒนาของเราได้ออกแบบ ${getAppDomain()} ให้เรียบง่ายและสะดวกในการใช้งาน เพื่อให้เป็นแพลตฟอร์มที่ช่วยประหยัดเวลาให้กับทั้ง ฟรีแลนซ์ และลูกค้า อีกทั้งยังช่วยสนับสนุนการสร้างธุรกิจใหม่ ๆ ให้กับผู้ประกอบการและยกระดับมาตรฐานของฟรีแลนซ์ไทยให้ดียิ่งขึ้น`,
            platformPurpose: `${getAppDomain()} ทำหน้าที่เป็นสื่อกลางออนไลน์ระหว่าง ฟรีแลนซ์ และผู้ว่าจ้าง ให้สามารถพบกันและทำงานร่วมกันได้ทุกที่ทุกเวลา โดยที่ ฟรีแลนซ์ สามารถใช้เว็บไซต์ ${getAppDomain()} ในการลงประกาศรับงานได้อย่างสะดวกในที่เดียว อีกทั้งยังมีระบบการคัดกรองที่ช่วยให้ลูกค้าสามารถเปรียบเทียบราคาและคุณภาพของ ฟรีแลนซ์ ได้ง่ายขึ้น ${getAppDomain()} ยังรับประกันการส่งมอบงานให้เสร็จสมบูรณ์ก่อนที่ฟรีแลนซ์จะได้รับเงิน เพื่อความมั่นใจของทั้งสองฝ่าย`,
