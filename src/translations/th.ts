...
export const th = {
    ...
    translation: {
        ...
        profileChat: {
            ...
            jobFlow: "ลำดับงาน",
            orders: "คำสั่งงาน",
            ordersActive: "กำลังดำเนินการ",
            ordersCompleted: "เสร็จสิ้น",
            ordersCancelled: "ยกเลิกแล้ว",
            ordersEmpty: "ยังไม่มีคำสั่งงานในการสนทนานี้",
            ordersOrderNumber: "คำสั่งงานที่ {{n}}",
            ordersEscrowHeld: "อยู่ในเอสโครว์",
            ordersEscrowPaidOut: "จ่ายแล้ว",
            ordersEscrowRefunded: "คืนเงินแล้ว",
            ordersFinishedApprox: "โดยประมาณ",
            ordersHireAgain: "จ้างอีกครั้ง",
            ordersPickPost: "คำสั่งงานนี้สำหรับงานใด",
            ordersSelectorCount: "{{count}} ออเดอร์",
            ordersSelectorNone: "ยังไม่ได้เลือกออเดอร์",
            ordersHistoryTitle: "ประวัติออเดอร์",
            ordersShowingOf: "แสดง {{shown}} จาก {{total}}",
            ordersLoadMore: "โหลดออเดอร์ก่อนหน้า",
            ordersPostBudget: "งบประมาณ {{amount}}",
            ordersPickPostLoading: "กำลังโหลดงานของคุณ…",
            ordersNoPostsToHire: "คุณยังไม่มีงานสำหรับจ้าง",
            ordersPostAJob: "ประกาศงานใหม่",
            media: "สื่อ",
            tabChat: "แชท",
            tabOrder: "คำสั่งงาน",
            closeDrawer: "ปิด",
        ...
        authen: {
            ...
            phoneTaken: "เบอร์โทรศัพท์นี้ถูกใช้งานแล้ว กรุณาเข้าสู่ระบบ",
            invalidPhone: "รูปแบบเบอร์โทรศัพท์ไม่ถูกต้อง",
            identityPlatformPhoneTaken: "เบอร์โทรศัพท์นี้ถูกใช้งานแล้ว กรุณาเข้าสู่ระบบ",
            identityPlatformInvalidPhone: "รูปแบบเบอร์โทรศัพท์ไม่ถูกต้อง",
            identityPlatformRegistrationFailed: "ไม่สามารถสร้างบัญชีได้ กรุณาลองใหม่อีกครั้ง",
            ...
            passkeyOfferTitle: "ครั้งหน้าไม่ต้องรอรหัส SMS ไหม?",
            passkeyOfferBody: "สร้างพาสคีย์สำหรับ {{identifier}} ครั้งต่อไปคุณจะเข้าสู่ระบบบนอุปกรณ์นี้ได้ด้วยการแตะเพียงครั้งเดียว โดยไม่ต้องรอรหัส",
            passkeyOfferAccept: "สร้างพาสคีย์",
            passkeyOfferDecline: "ไว้ทีหลัง",
        ...
        categoryFooter: {
            ...
            seoDescription2Part1: `คุณภาพ ช่วยให้เว็บไซต์ของคุณแสดงเป็นอันดับต้น ๆ บน Google ทำให้เว็บไซต์ของคุณมีโอกาสที่คนเข้าชมสูงขึ้นและเป็นที่รู้จักมากขึ้น ที่ ${getAppName()} เรามีฟรีแลนซ์ให้บริการ SEO ผู้เชี่ยวชาญที่มีประสบการณ์ในการ `,
        ...
        home: {
            ...
            platformDescription: `${getAppName()} คือเว็บไซต์ที่รวบรวม ฟรีแลนซ์ มืออาชีพจากหลากหลายสายงานไว้ในที่เดียวกัน ไม่ว่าจะเป็น งานออกแบบกราฟิก ทำแบนเนอร์โฆษณา เขียนบทความ แปลภาษา การตลาดออนไลน์ พัฒนาเว็บไซต์ และงานอื่นๆ อีกกว่า 90 หมวดหมู่ เพื่อตอบโจทย์ความต้องการที่หลากหลายของทั้งผู้ประกอบการและผู้ใช้งานทั่วไป ทีมพัฒนาของเราได้ออกแบบ ${getAppName()} ให้เรียบง่ายและสะดวกในการใช้งาน เพื่อให้เป็นแพลตฟอร์มที่ช่วยประหยัดเวลาให้กับทั้ง ฟรีแลนซ์ และลูกค้า อีกทั้งยังช่วยสนับสนุนการสร้างธุรกิจใหม่ ๆ ให้กับผู้ประกอบการและยกระดับมาตรฐานของฟรีแลนซ์ไทยให้ดียิ่งขึ้น`,
            platformPurpose: `${getAppName()} ทำหน้าที่เป็นสื่อกลางออนไลน์ระหว่าง ฟรีแลนซ์ และผู้ว่าจ้าง ให้สามารถพบกันและทำงานร่วมกันได้ทุกที่ทุกเวลา โดยที่ ฟรีแลนซ์ สามารถใช้เว็บไซต์ ${getAppName()} ในการลงประกาศรับงานได้อย่างสะดวกในที่เดียว อีกทั้งยังมีระบบการคัดกรองที่ช่วยให้ลูกค้าสามารถเปรียบเทียบราคาและคุณภาพของ ฟรีแลนซ์ ได้ง่ายขึ้น ${getAppName()} ยังรับประกันการส่งมอบงานให้เสร็จสมบูรณ์ก่อนที่ฟรีแลนซ์จะได้รับเงิน เพื่อความมั่นใจของทั้งสองฝ่าย`,
        ...
        notifications: {
            ...
            emptyState: "กิจกรรมและการแจ้งเตือนจะปรากฏที่นี่",
            loading: "กำลังโหลดการแจ้งเตือน...",
            loadErrorTitle: "โหลดการแจ้งเตือนไม่สำเร็จ การแจ้งเตือนของคุณยังอยู่ กรุณาลองใหม่",
            ...
            riderRejectedTitle: "ใบสมัครไรเดอร์ของคุณต้องแก้ไข",
            riderRejectedBody: "คลิกเพื่อดูสิ่งที่ต้องแก้ไขแล้วส่งอีกครั้ง",
            riderSubmittedTitle: "ส่งใบสมัครไรเดอร์แล้ว",
            riderResubmittedTitle: "ส่งใบสมัครไรเดอร์อีกครั้งแล้ว",
            riderResubmissionReceivedTitle: "เราได้รับใบสมัครที่อัปเดตของคุณแล้ว",
        ...
        profileCoins: {
            ...
            noteMinMax: "ขั้นต่ำ 20 บาท และสูงสุด 50,000 บาท",
            placeholderSpecifyAmount: "ระบุจำนวนเงิน 20-50,000 บาท",
        ...
        terms: {
            ...
            termsAndConditionsTitle: `ข้อกำหนดและเงื่อนไขการใช้แพลตฟอร์ม ${getAppDomain()} สำหรับฟรีแลนซ์`,
            section1Title: "คำนิยาม",
            definition1: `แพลตฟอร์มหมายถึงเว็บไซต์ (https://${getAppDomain()}) และแอปพลิเคชัน ${getAppName()}`,
            definition2:
            ...
            definition6: `บริษัทคือองค์กรที่บริหาร ${getAppDomain()}`,
            ...
            privacyPolicy1: `อ่านนโยบายความเป็นส่วนตัวของเราที่ https://${getAppDomain()}/seller-privacy`,
            ...
            contact4: `อีเมล: support@${getAppDomain()}`,
            contact5: `เว็บไซต์: https://static.${getAppDomain()}/contents/support-center`,
        ...
        termsEmployer: {
            ...
            definitionPlatform: `“แพลตฟอร์ม” หมายถึง เว็บไซต์ (https://${getAppDomain()}/) หรือแอปพลิเคชั่น ${getAppName()} ของบริษัทฯ เป็นช่องทางและเป็นพื้นที่กลางที่เปิดให้ผู้ใช้งานสามารถสร้าง แบ่งปัน ขาย และซื้องานหรือบริการในรูปแบบของการชำระเงินตามมูลค่าที่ถูกกำหนดเอาไว้ของงานหรือบริการดังกล่าว`,
            definitionWork:
            ...
            privacyPage: {
                ...
                marketingUnsubscribe: "ในกรณีที่ท่านไม่ต้องการรับข่าวสารการโฆษณาและ/หรือข้อมูลทางการตลาดจากบริษัทฯ (communication@108heros.com) ท่านสามารถคลิก ‘Unsubscribe’ ผ่านจดหมายอิเล็กทรอนิกส์ที่บริษัทฯ จัดส่งหรือเพิกถอนความยินยอมตามรายละเอียดด้านล่าง",
        ...
        admin: {
            ...
            notifications: {
                ...
                panelDescription: "ใบสมัครไรเดอร์ที่ต้องตรวจสอบ",
                pendingCount: "รอดำเนินการ {{count}} รายการ",
                loading: "กำลังโหลด…",
                emptyTitle: "ตรวจสอบครบแล้ว",
                ...
                badgeSubmitted: "ใหม่",
                badgeResubmitted: "ส่งอีกครั้ง",
                badgeUpdate: "อัปเดต",
                riderRef: "ไรเดอร์ #{{id}}",
                viewQueue: "ดูคิวตรวจสอบไรเดอร์",
            },
            riders: {
                // Page title & tabs
                title: "จัดการไรเดอร์",
