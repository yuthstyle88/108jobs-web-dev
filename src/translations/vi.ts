...
export const vi = {
    ...
    translation: {
        ...
        validation: {
            ...
            deadlineMin: "Hạn chót phải từ ngày mai trở đi",
        },
        profileChat: {
            price: "ngân sách",
            jobFlow: "Quy trình công việc",
            orders: "Đơn hàng",
            ordersActive: "Đang thực hiện",
            ordersCompleted: "Hoàn thành",
            ordersCancelled: "Đã hủy",
            ordersEmpty: "Chưa có đơn hàng nào trong cuộc trò chuyện này.",
            ordersOrderNumber: "Đơn hàng #{{n}}",
            ordersEscrowHeld: "Đang ký quỹ",
            ordersEscrowPaidOut: "Đã thanh toán",
            ordersEscrowRefunded: "Đã hoàn tiền",
            ordersFinishedApprox: "ước tính",
            ordersHireAgain: "Thuê lại",
            ordersPickPost: "Đơn hàng này dành cho công việc nào?",
            ordersSelectorCount: "{{count}} đơn",
            ordersSelectorNone: "Chưa chọn đơn nào",
            ordersHistoryTitle: "Lịch sử đơn hàng",
            ordersShowingOf: "Hiển thị {{shown}} trên {{total}}",
            ordersLoadMore: "Tải các đơn cũ hơn",
            ordersPostBudget: "Ngân sách {{amount}}",
            ordersPickPostLoading: "Đang tải công việc của bạn…",
            ordersNoPostsToHire: "Bạn chưa có công việc nào để thuê.",
            ordersPostAJob: "Đăng công việc mới",
            media: "Phương tiện",
            tabChat: "Trò chuyện",
            tabOrder: "Đơn hàng",
            closeDrawer: "Đóng",
            ...
            attachFileFirst: "Vui lòng đính kèm tệp trước khi nộp sản phẩm.",
            dropFiles: "Thả tệp vào đây",
            missingBillingId: "Thiếu mã thanh toán. Vui lòng tạo/phê duyệt báo giá trước.",
            validation: {
                ...
                workStepSeq: "Thứ tự các bước phải từ 1 trở lên",
            },
        ...
        authen: {
            ...
            labelUsernameOrEmail: "Tên người dùng hoặc số điện thoại",
            ...
            placeholderUsernameOrEmail: "Nhập tên người dùng hoặc số điện thoại của bạn",
            ...
            buttonLoginPassword: "Đăng nhập bằng mật khẩu",
            buttonLoginOtp: "Đăng nhập bằng số điện thoại (OTP)",
            errorUsernameOrEmailRequired: "Vui lòng nhập tên người dùng hoặc số điện thoại",
            errorPasswordRequired: "Vui lòng nhập mật khẩu",
            errorPasswordVerifyRequired: "Vui lòng xác nhận mật khẩu",
            invalidLoginCredentials: "Tên người dùng/số điện thoại hoặc mật khẩu không chính xác.",
            ...
            phoneTaken: "Số điện thoại này đã được đăng ký. Vui lòng đăng nhập.",
            invalidPhone: "Định dạng số điện thoại không hợp lệ.",
            identityPlatformPhoneTaken: "Số điện thoại này đã được đăng ký. Vui lòng đăng nhập.",
            identityPlatformInvalidPhone: "Định dạng số điện thoại không hợp lệ.",
            identityPlatformRegistrationFailed: "Tạo tài khoản không thành công. Vui lòng thử lại.",
            ...
            passkeyOfferTitle: "Lần sau bỏ qua mã SMS?",
            passkeyOfferBody: "Tạo passkey cho {{identifier}}. Lần sau bạn có thể đăng nhập trên thiết bị này chỉ với một chạm, không cần chờ mã.",
            passkeyOfferAccept: "Tạo passkey",
            passkeyOfferDecline: "Để sau",
        ...
        global: {
            ...
            delete: "Xóa",
            serverError: "Đã xảy ra lỗi máy chủ. Vui lòng thử lại.",
            submissionFailed: "Gửi thất bại. Vui lòng thử lại.",
            tryRefreshingPage: "Thử tải lại trang",
            view: "Xem",
        ...
        notifications: {
            ...
            emptyState: "Hoạt động và thông báo sẽ xuất hiện ở đây",
            loading: "Đang tải thông báo...",
            loadErrorTitle: "Không thể tải thông báo. Không có gì bị mất — vui lòng thử lại.",
            ...
            riderRejectedTitle: "Đơn đăng ký tài xế của bạn cần chỉnh sửa",
            riderRejectedBody: "Nhấp để xem cần sửa gì rồi gửi lại.",
            riderSubmittedTitle: "Đã gửi đơn đăng ký tài xế",
            riderResubmittedTitle: "Đã gửi lại đơn đăng ký tài xế",
            riderResubmissionReceivedTitle: "Chúng tôi đã nhận đơn cập nhật của bạn",
            riderResubmissionReceivedBody: "Quản trị viên sẽ xem xét trong thời gian ngắn.",
        },
        profile: {
            addWorkSamples: "Thêm mẫu công việc",
            editWorkSamples: "Chỉnh sửa mẫu công việc",
            loading: "Đang tải…",
        ...
        profileCoins: {
            ...
            topUpSuccessMessage: "Bạn đã nạp tiền thành công, vui lòng đợi quản trị viên phê duyệt thanh toán",
            stillDoNotPayYet:
            ...
            transferModal: {
                ...
                description: "Chuyển xu từ giao dịch nạp này vào ví của người dùng.",
        ...
        profileInfo: {
            ...
            deleteWorkSample: "Xóa mẫu công việc",
            nextSamples: "Mẫu công việc tiếp theo",
            previousSamples: "Mẫu công việc trước đó",
            updateAvailableFail: "Cập nhật trạng thái nhận việc thất bại",
        ...
        sellerBankAccount: {
            maxAccountsLimit: "Bạn có thể liên kết tối đa {{max}} tài khoản ngân hàng.",
        ...
        termsEmployer: {
            ...
            privacyPage: {
                ...
                marketingUnsubscribe: "Nếu bạn không muốn nhận thông tin quảng cáo và/hoặc tiếp thị từ Công ty (communication@108heros.com), bạn có thể nhấp ‘Unsubscribe’ trong email do Công ty gửi hoặc rút lại sự đồng ý như mô tả bên dưới.",
        ...
        admin: {
            ...
            category: {
                ...
                subcategoryCount: "{{count}} danh mục con",
            ...
            notifications: {
                ...
                panelDescription: "Hồ sơ tài xế cần được xét duyệt",
                pendingCount: "{{count}} đang chờ",
                loading: "Đang tải…",
                emptyTitle: "Đã xử lý xong",
                ...
                badgeSubmitted: "Mới",
                badgeResubmitted: "Gửi lại",
                badgeUpdate: "Cập nhật",
                riderRef: "Tài xế #{{id}}",
                viewQueue: "Xem hàng đợi xét duyệt tài xế",
            },
            riders: {
                // Page title & tabs
